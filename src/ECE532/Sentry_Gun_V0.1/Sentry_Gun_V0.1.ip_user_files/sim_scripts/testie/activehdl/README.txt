...
#
# Generated by export_simulation on Fri Mar 31 00:07:08 -0400 2017
#
################################################################################
...
switch to the './testie.sh' script.
...
./testie.sh -noclean_files

For more information on the script, please type './testie.sh -help'.
